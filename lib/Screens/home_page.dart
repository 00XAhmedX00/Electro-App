...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => ProductLogic()..getAllProducts(),
    child: BlocConsumer<ProductLogic , ProductState>(listener: (context, state){
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            state is LoadingProduct ? Center(child: SizedBox(
              width: 85,
              height: 85,
              ...
              child: Row(
                ...
                children: [
                  ...products.map((product) {
                    return InkWell(
                      onTap: () => goTo(context: context , page: ProductDetails(product: product,), routed: true),
                      child: Padding(

...
class DiscountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => ProductLogic()..getDiscountedProducts()
    , child: BlocConsumer<ProductLogic , ProductState>(listener: (context , state){} , builder: (context , state){
      ...
      body: SafeArea(
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final discountRate = price > 0 ? ((price - priceAfter) / price * 100).round() : 0;
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            goTo(context: context, page: ProductDetails(product: product) , routed: true);
                          },
